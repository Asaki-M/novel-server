import type { Character, CreateCharacterRequest, UpdateCharacterRequest } from '../types/character.js'
...
class CharacterService {
  ...
  async updateCharacter(id: string, updates: UpdateCharacterRequest): Promise<Character | null> {
    ...
    if (updates.backstoryPrompt !== undefined)
      toUpdate.backstory_prompt = updates.backstoryPrompt
    if (updates.backstory !== undefined)
      toUpdate.backstory = updates.backstory
