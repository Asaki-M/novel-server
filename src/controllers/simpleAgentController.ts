 ...
 */
export const simpleAgentChat = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const {
      input,
      temperature,
 ...
 */
export const simpleAgentChatStream = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const {
      input,
      temperature,
 ...
 */
export const simpleAgentHealthCheck = async (_req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
 ...
 */
export const simpleAgentInfo = async (_req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const response: ApiResponse = {
      success: true,
      data: {
